...
export function PageHeader({
  ...
  return (
    <header className={`bg-white border-b border-gray-200 flex-shrink-0 z-10 ${className}`}>
      <div className="flex items-center justify-between px-4 h-14">
        ...
        <div className="flex items-center gap-2">
          {showContextSelector && <ContextSelector onContextChange={onContextChange} />}
          {action}
        </div>
      </div>
    </header>
