...
/**
 * LLM Model Display Information
 * Centralized list of all available LLM models with their display names and descriptions
 */
...
export const AVAILABLE_LLM_MODELS: LLMModelInfo[] = [
  {
    ...
    name: 'GPT-5',
    provider: 'OpenAI',
    description: 'Most advanced reasoning and creativity with exceptional performance across all tasks.'
  },
  {
    id: 'gpt-5-mini',
    name: 'GPT-5 mini',
    provider: 'OpenAI',
    description: 'Fast and efficient with strong general capabilities for everyday tasks.'
  },
  {
    id: 'claude-sonnet-4.5',
    name: 'Claude Sonnet 4.5',
    provider: 'Anthropic',
    description: 'Superior reasoning and analysis with balanced speed and capability.'
  },
  {
    id: 'claude-haiku-4.5',
    name: 'Claude Haiku 4.5',
    provider: 'Anthropic',
    description: 'Ultra-fast responses with excellent quality for rapid interactions.'
  },
  {
    id: 'gemini-2.5-pro',
    name: 'Gemini 2.5 Pro',
    provider: 'Google',
    description: 'Advanced multimodal understanding with exceptional long-context capabilities.'
  },
  {
    id: 'gemini-2.5-flash',
    name: 'Gemini 2.5 Flash',
    provider: 'Google',
    description: 'Lightning-fast with strong performance for time-sensitive tasks.'
  },
  {
    id: 'grok-4',
    name: 'Grok-4',
    provider: 'xAI',
    description: 'Real-time knowledge with direct access to current information and events.'
  }
];
