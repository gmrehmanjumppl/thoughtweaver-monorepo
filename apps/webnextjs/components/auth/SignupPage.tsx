...
import { Button, Card } from '@thoughtweaver/ui';
      ...
      <Card className="w-full max-w-md p-8">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-center">
            <h1 className="mb-2">Thoughtweaver</h1>
            <p className="text-gray-600">Unlock your creative potential with AI-powered ideation</p>
          </div>
